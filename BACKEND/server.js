...
const db = mysql.createConnection({
    host: "bxiror6uqmwqsvz0gybr-mysql.services.clever-cloud.com",
    user: "uh6wxqamb9dty6ie",
    password: "BzaEhYdqFWUApnAFD0Kc",
    database: "bxiror6uqmwqsvz0gybr" // Change the database name to "library"
});
...
app.post('/addBook', (req, res) => {
    try{
    const {title,author,subject,publishDate,availableCopies}=req.body
    ...
    db.query(sql, [title,author,subject,publishDate,availableCopies], (err, data) => {
        if (err) {
